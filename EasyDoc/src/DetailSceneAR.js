    ...
    "DBMSM": [
      {
        ...
        resources: [require('../assets/2D_model/cube01m.mtl')],
        material:"dbmsm",
      },
    ],
    "DBInstance": [
      {
        ...
        resources: [require('../assets/2D_model/cube02m.mtl')],
        material: "dbl",
      },
      {
        id: "AppGM",
        ...
        rotation: [0, -90, 90],
        source: require('../assets/2D_model/cube01-1.obj'),
        resources: [require('../assets/2D_model/cube01-1m.mtl')],
        material: "appgml"
      },
      {
        id: "Heap",
        ...
        resources: [require('../assets/2D_model/cube04m.mtl')],
        material: "heap"
      },
      {
        id: "Heap",
      ...
      },
      {
        ...
        resources: [require('../assets/2D_model/cube03m.mtl')],
        material: "dbgml",
      },
    ],
  };
